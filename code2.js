...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10903156);
}
if (isConditionTrue_0) {
...
};gdjs.level1Code.asyncCallback10916988 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(4), (runtimeScene) => (gdjs.level1Code.asyncCallback10916988(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.level1Code.asyncCallback10920796 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.level1Code.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.level1Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.level1Code.asyncCallback10920796(runtimeScene, asyncObjectsList)));
}
}
...
{for(var i = 0, len = gdjs.level1Code.GDspr_9595npcObjects3.length ;i < len;++i) {
    gdjs.level1Code.GDspr_9595npcObjects3[i].getBehavior("Tween").addObjectPositionTween2("pos" + gdjs.level1Code.GDspr_9595npcObjects3[i].getVariables().getFromIndex(14).getAsString(), (( gdjs.level1Code.GDspr_9595nodoObjects3.length === 0 ) ? 0 :gdjs.level1Code.GDspr_9595nodoObjects3[0].getPointX("")), (( gdjs.level1Code.GDspr_9595nodoObjects3.length === 0 ) ? 0 :gdjs.level1Code.GDspr_9595nodoObjects3[0].getPointY("")), "linear", 1, false);
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(1)) == runtimeScene.getScene().getVariables().getFromIndex(0).getAsNumber();
if (isConditionTrue_0) {
...
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.level1Code.mapOfGDgdjs_9546level1Code_9546GDspr_95959595npcObjects3Objects, (( gdjs.level1Code.GDspr_9595nodoSpawnObjects3.length === 0 ) ? 0 :gdjs.level1Code.GDspr_9595nodoSpawnObjects3[0].getPointX("")), (( gdjs.level1Code.GDspr_9595nodoSpawnObjects3.length === 0 ) ? 0 :gdjs.level1Code.GDspr_9595nodoSpawnObjects3[0].getPointY("")), "npcWayPoints");
    ...
    gdjs.level1Code.GDspr_9595npcObjects3[i].returnVariable(gdjs.level1Code.GDspr_9595npcObjects3[i].getVariables().getFromIndex(7)).setNumber(1);
}
}
{ //Subevents
...
gdjs.copyArray(runtimeScene.getObjects("txt_debug1"), gdjs.level1Code.GDtxt_9595debug1Objects3);
...
}{for(var i = 0, len = gdjs.level1Code.GDtxt_9595debug1Objects3.length ;i < len;++i) {
    gdjs.level1Code.GDtxt_9595debug1Objects3[i].getBehavior("Text").setText(runtimeScene.getScene().getVariables().getFromIndex(0).getAsString());
}
}
{ //Subevents
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSecondsOrNaN(runtimeScene, "timeOutSpawn") >= 3;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
};gdjs.level1Code.userFunc0xc43ea0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
let thisLoop = setInterval(()=>{
    ...
    arrayNpcs.forEach((thisNpc)=>{
        ...
        arrayNodos.forEach((thisNode)=>{
            ...
            if (idNd == nxtNd) {                
                console.log("nodo reached: " + idNd+ " sqdist = ", d);
            }  else {
                console.log("nodo to reach: " + nxtNd + " (not yet): " + d);
            }
        })
    })
},500);
...
var objects = [];
objects.push.apply(objects,gdjs.level1Code.GDspr_9595nodoObjects2);
gdjs.level1Code.userFunc0xc43ea0(runtimeScene, objects);

}


};gdjs.level1Code.asyncCallback11024668 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.level1Code.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.level1Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.level1Code.asyncCallback11024668(runtimeScene, asyncObjectsList)));
}
}
